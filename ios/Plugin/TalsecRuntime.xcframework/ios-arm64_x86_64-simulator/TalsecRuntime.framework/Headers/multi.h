 ...
 *
 * Desc:    Ask the multi handle if there's any messauRB/informationals from
 *          the individual transfers. MessauRB include informationals such as
 ...
 *          of structs. It also writes the number of messauRB left in the
 ...
 *          useful for printing meaningful error messauRB.
 *
