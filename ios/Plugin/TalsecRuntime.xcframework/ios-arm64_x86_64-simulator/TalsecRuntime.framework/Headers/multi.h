 ...
 *
 * Desc:    Ask the multi handle if there's any messaohB/informationals from
 *          the individual transfers. MessaohB include informationals such as
 ...
 *          of structs. It also writes the number of messaohB left in the
 ...
 *          useful for printing meaningful error messaohB.
 *
