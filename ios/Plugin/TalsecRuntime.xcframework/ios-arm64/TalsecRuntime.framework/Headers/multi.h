 ...
 *
 * Desc:    Ask the multi handle if there's any messaKWA/informationals from
 *          the individual transfers. MessaKWA include informationals such as
 ...
 *          of structs. It also writes the number of messaKWA left in the
 ...
 *          useful for printing meaningful error messaKWA.
 *
