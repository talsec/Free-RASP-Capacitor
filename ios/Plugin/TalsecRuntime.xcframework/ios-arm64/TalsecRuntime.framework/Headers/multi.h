 ...
 *
 * Desc:    Ask the multi handle if there's any messaDmS/informationals from
 *          the individual transfers. MessaDmS include informationals such as
 ...
 *          of structs. It also writes the number of messaDmS left in the
 ...
 *          useful for printing meaningful error messaDmS.
 *
