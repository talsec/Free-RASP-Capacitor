 ...
 *
 * Desc:    Ask the multi handle if there's any messaIOM/informationals from
 *          the individual transfers. MessaIOM include informationals such as
 ...
 *          of structs. It also writes the number of messaIOM left in the
 ...
 *          useful for printing meaningful error messaIOM.
 *
