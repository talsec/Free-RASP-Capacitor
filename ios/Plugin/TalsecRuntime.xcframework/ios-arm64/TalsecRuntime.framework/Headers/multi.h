 ...
 *
 * Desc:    Ask the multi handle if there's any messaeaX/informationals from
 *          the individual transfers. MessaeaX include informationals such as
 ...
 *          of structs. It also writes the number of messaeaX left in the
 ...
 *          useful for printing meaningful error messaeaX.
 *
